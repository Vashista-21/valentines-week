...
// ============== VALENTINE'S DAYS ==============
const valentineDays = [
    { date: new Date(2026, 1, 7), name: "Rose Day", emoji: "🌹" },
    { date: new Date(2026, 1, 8), name: "Propose Day", emoji: "💍" },
    { date: new Date(2026, 1, 9), name: "Chocolate Day", emoji: "🍫" },
    { date: new Date(2026, 1, 10), name: "Teddy Day", emoji: "🧸" },
    { date: new Date(2026, 1, 11), name: "Promise Day", emoji: "🤝" },
    { date: new Date(2026, 1, 12), name: "Hug Day", emoji: "🤗" },
    { date: new Date(2026, 1, 13), name: "Kiss Day", emoji: "💋" },
    { date: new Date(2026, 1, 14), name: "Valentine's Day", emoji: "❤️" }
];
